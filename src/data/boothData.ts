...
// 4-day route plan - consolidated geographically
export const routePlan: RouteDay[] = [
  { day: 1, stops: [
    ...
    { order: 3, village: "தெற்கு புதூர்", distance: 0.8, lat: 9.2, lng: 77.43 },
    { order: 4, village: "வடக்கு புதூர்", distance: 0.4, lat: 9.203, lng: 77.428 },
    { order: 5, village: "பெரியசாமியாபுரம்", distance: 0.4, lat: 9.205, lng: 77.425 },
  ...
  { day: 2, stops: [
    ...
    { order: 3, village: "வெற்றம்பட்டி", distance: 1.2, lat: 9.228, lng: 77.405 },
    { order: 4, village: "கீழ திருவேட்டநல்லூர்", distance: 0.9, lat: 9.232, lng: 77.398 },
    { order: 5, village: "திருவேட்டநல்லூர்", distance: 0.5, lat: 9.235, lng: 77.395 },
    { order: 6, village: "பாம்பு கோவில்", distance: 0.8, lat: 9.24, lng: 77.39 },
  ]},
  { day: 3, stops: [
    { order: 1, village: "கே.வி. முத்துசாமியாபுரம்", distance: 0, lat: 9.23, lng: 77.385 },
    { order: 2, village: "புனைவனம்", distance: 1.5, lat: 9.245, lng: 77.385 },
    { order: 3, village: "பாரைக்குளம்", distance: 0.8, lat: 9.25, lng: 77.38 },
    { order: 4, village: "வடநத்தம்பட்டி", distance: 0.8, lat: 9.255, lng: 77.375 },
    { order: 5, village: "கீழ வீரசிகாமணி", distance: 0.5, lat: 9.258, lng: 77.372 },
    { order: 6, village: "வீரசிகாமணி", distance: 0.3, lat: 9.26, lng: 77.37 },
  ]},
  { day: 4, stops: [
    ...
    { order: 4, village: "பொய்கை மேடு", distance: 0.7, lat: 9.275, lng: 77.355 },
